...
def main():
    ...
    class_model, class_time = trainer.train(class_model, lr=class_lr, epochs=class_epochs, batch_size=class_batch_size, train_loader=train_loader, val_loader=val_loader_class, dataset='CIFAR100')
    evaluator = Evaluator('ann_classifier')
    class_accuracy, class_cm, class_precision, class_recall, class_f1 = evaluator.evaluate(class_model, val_loader=val_loader_class)
